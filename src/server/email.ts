...
export function paymentConfirmedEmail(name: string, plan: string, whatsappUrl: string, cohortDate: string) {
  return `
    <div style="font-family:sans-serif;max-width:560px;margin:0 auto;color:#111;">
      ...
      ${
        whatsappUrl
          ? `<p><a href="${whatsappUrl}" style="display:inline-block;background:#25D366;color:#fff;padding:12px 20px;border-radius:8px;text-decoration:none;font-weight:600;">Rejoindre le groupe WhatsApp</a></p>`
