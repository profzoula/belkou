  ...
  return (
    <section className="py-16 sm:py-20 md:py-24">
      <div className="site-container">
        <div className="relative overflow-hidden rounded-2xl bg-gradient-primary p-6 sm:p-10 md:p-14 text-center shadow-primary">
          ...
          <div className="relative max-w-lg mx-auto">
            ...
            <Button
              asChild
              size="lg"
              className="w-full sm:w-auto touch-target bg-card text-foreground hover:bg-card/95 shadow-md"
            >
              <Link to="/register">
