...
export function FAQ() {
  return (
    <section id="faq" className="section-divider py-20 md:py-24 bg-card">
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-5 gap-12 max-w-5xl mx-auto">
          ...
          <div className="lg:col-span-3 surface rounded-2xl px-5 md:px-6">
            <Accordion type="single" collapsible className="w-full">
              {faqs.map((f, i) => (
                <AccordionItem key={i} value={`item-${i}`} className="border-border last:border-0">
                  <AccordionTrigger className="text-left text-sm font-medium hover:text-primary py-4 hover:no-underline">
                    {f.q}
                  </AccordionTrigger>
