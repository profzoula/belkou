  ...
  return (
    <article className="flex h-full flex-col overflow-hidden rounded-2xl border border-border bg-card shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:border-primary/25 hover:shadow-md">
      <div className={cn("relative aspect-[16/10] overflow-hidden bg-gradient-to-br", service.gradient)}>
        ...
        {service.premium ? (
          <span className="absolute left-3 top-3 z-10 inline-flex items-center gap-1 rounded-md bg-brand-accent px-2.5 py-1 text-[10px] font-bold uppercase tracking-wide text-brand-accent-foreground shadow-sm">
      ...
      <div className="flex flex-1 flex-col p-4 sm:p-5">
        ...
        <p className="mt-3 font-display text-lg font-semibold">{service.priceLabel}</p>
