  ...
  head: () => ({
    meta: [
      ...
      { name: "author", content: siteConfig.name },
      {
        ...
        content: "_Qd_0xmPDvamHzkj7ZQs-djO0B6BWD6ay4fe1MN0JOk",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Roboto+Mono:wght@400;500&family=Source+Sans+3:ital,wght@0,300;0,400;0,600;0,700;1,400&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,
