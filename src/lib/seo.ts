...
export const defaultTitle = "BelKou — Apprenez à créer des Apps IA et des SaaS";

export const defaultDescription =
  "Vous n'avez pas besoin d'être développeur. Créez, lancez et vendez votre premier produit digital avec l'IA — formation en français, mentorat et communauté active.";
